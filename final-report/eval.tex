...
\caption{A screen shot of a program to simulate the expected functionality of Guide Dog, which was
used to aid development of the audio system. The user is represented by the
white box, the destination by the pink box, and the obstacles by the green boxes. The
