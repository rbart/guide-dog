...
% Don't allow single lines by themselves
\widowpenalty=10000
\clubpenalty=10000
...
This paper details the authors' experiences designing, building and improving
Guide Dog. Included is a detailed description of the technologies used and the
paths the authors took to get a final, working product.

Guide Dog's implementation is available online for anyone to try and build
upon.
\end{abstract}

\keywords{RGB-D cameras, accessibility tools, computer vision,
  object recognition, auditory display, blind navigation, sonification} % NOT required for Proceedings
