...
image by treating it as an 8-connected graph. If multiple blobs are detected,
...
within the largest blob, which is returned as the final estimate of the location
